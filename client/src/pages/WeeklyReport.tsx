            ...
            <table style={{ width: "100%", borderCollapse: "collapse", margin: "12px 0", fontSize: "12px" }}>
              ...
              <tbody>
                {issuesNeedingResolution.map((i, idx) => (
                  <tr key={`issue-res-${i.issueId || ''}-${idx}`}>
